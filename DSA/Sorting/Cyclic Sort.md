...
## [Algorithm](https://utkarsh1504.github.io/DSA-Java/cyclesort#algorithm)
...
## [Code Implementation](https://utkarsh1504.github.io/DSA-Java/cyclesort#code-implementation)
...
### [Explanation of the example arr [] = {5, 4, 3, 2, 1}](https://utkarsh1504.github.io/DSA-Java/cyclesort#explanation-of-the-example-arr---5-4-3-2-1)
...
Step 2: So, 5 will take the position of 1 and then count the number of elements less than 1, there are no elements less than 1 . move `1` to 1st place in the array ( Index = 0 ).

Step 3: The original position of 5 is acquired and one cycle is completed

Step 5: Repeat same for all elements.

## [Complexity analysis](https://utkarsh1504.github.io/DSA-Java/cyclesort#complexity-analysis)
